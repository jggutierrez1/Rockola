...
Begin VB.Form Main_Form 
   ...
   ClientTop       =   840
   ClientWidth     =   15240
   Icon            =   "Main_Full.frx":0000
   LinkTopic       =   "Form1"
   Picture         =   "Main_Full.frx":08CA
   ScaleHeight     =   11520
   ScaleWidth      =   15240
   ...
   Begin TbackLibCtl.TBack TBack3 
      ...
      Begin CTMEDITLibCtl.ctMEdit otTema_Act 
         ...
         EndProperty
         Enabled         =   0   'False
         DropPicture     =   "Main_Full.frx":26518
         BackColor       =   16576
         ForeColor       =   65535
   ...
   Begin TbackLibCtl.TBack oFrame_in_Sel 
      ...
      Begin CTMEDITLibCtl.ctMEdit otCodigo 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropPicture     =   "Main_Full.frx":2657D
         BackColor       =   16576
         ForeColor       =   65535
         UseMaskChars    =   0   'False
         EditMask        =   "99-99-99"
      ...
      Begin VB.Image Image3 
         Height          =   810
         Left            =   3480
         MouseIcon       =   "Main_Full.frx":26599
         MousePointer    =   99  'Custom
         Picture         =   "Main_Full.frx":266EB
         Stretch         =   -1  'True
   ...
   Begin TbackLibCtl.TBack TBack1 
      ...
      Begin VB.ListBox oBkList 
         ...
         Height          =   255
         ItemData        =   "Main_Full.frx":26AF9
         Left            =   0
         List            =   "Main_Full.frx":26B00
         TabIndex        =   46
         Top             =   6120
         Width           =   2415
      End
      ...
      Begin VB.ListBox oLst_Popular 
         DataSource      =   "oDC_Temas"
         Height          =   255
         ItemData        =   "Main_Full.frx":26B0D
         Left            =   0
         List            =   "Main_Full.frx":26B0F
         TabIndex        =   44
         Top             =   6480
         Width           =   2415
      End
   ...
   Begin VB.Label olT_Mant 
      ...
      BackColor       =   &H80000009&
      BorderStyle     =   1  'Fixed Single
      Caption         =   "Opción de servicio activada [00:00:00] Restante                99-00-06 DESACTIVAR "
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   18
         Charset         =   0
   ...
   Begin VB.Label Label4 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "@2005-Johnn G. Gutierrez A.-Derechos reservados@"
      BeginProperty Font 
         Name            =   "Comic Sans MS"
         Size            =   8.25
         Charset         =   0
...
If igKeep_Cred = 1 Then
    Me.olLabMetros.Visible = False
    Me.olMetros.Visible = False
Else
    Me.olLabMetros.Visible = True
    Me.olMetros.Visible = True
End If
End Sub
...
igMax_Gen = 15 - 2: igMax_Dis = 12: igMax_Can = 16 - 2 'valores fijos su valor no pueded ser superior
igInd_Bon = 0
igNext_Bonus = 0
piCnt_Canc = 0
igShowPass = 0
...
'   ----------------------------------
    ...
    .Check3(9).value = igStartPlayMusic
'   ----------------------------------
